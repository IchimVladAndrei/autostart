package com.autodrive.authuser.config;
    ...
    SecurityFilterChain securityFilterChain(HttpSecurity http, CorsConfigurationSource corsConfigurationSource, JwtAuthenticationFilter jwtAuthenticationFilter) throws Exception {
        ...
        return http
                .csrf(csrf -> csrf
                        ...
                        .ignoringRequestMatchers("/api/internal/**","/actuator/**"))
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        .requestMatchers("/api/v1/auth/csrf", "/api/v1/auth/login", "/api/v1/auth/register", "/api/v1/auth/refresh", "/api/v1/auth/logout", "/api/internal/**", "/error").permitAll()
